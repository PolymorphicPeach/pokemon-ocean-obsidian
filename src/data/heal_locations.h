static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_BRINESHORE_TOWN_LIGHTHOUSE_1F - 1] = {MAP_GROUP(BRINESHORE_TOWN_LIGHTHOUSE_1F), MAP_NUM(BRINESHORE_TOWN_LIGHTHOUSE_1F), 3, 3},
    [HEAL_LOCATION_BRINESHORE_TOWN - 1] = {MAP_GROUP(BRINESHORE_TOWN), MAP_NUM(BRINESHORE_TOWN), 29, 23},
    [HEAL_LOCATION_ROUTE_1 - 1] = {MAP_GROUP(ROUTE1), MAP_NUM(ROUTE1), 21, 11},
};
