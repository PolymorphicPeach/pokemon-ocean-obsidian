...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_DEWFORD_TOWN] = MAPPOPUP_THEME_STONE,
    ...
    // New entries must container " - KANTO_MAPSEC_COUNT " to appear on the world map.
    // To be changed later to be included
    [MAPSEC_BRINESHORE_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GILDED_HOLLOW] = MAPPOPUP_THEME_STONE2,
};
